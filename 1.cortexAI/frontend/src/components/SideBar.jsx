...
import { User, Coins, LogOut, PanelRight } from 'lucide-react';
            ...
            <div className='relative shrink-0'>
              {
                ...
                :
                <div className='w-9 h-9 rounded-[10px] bg-white/[0.06] flex items-center justify-center'> <User size={15} className="text-slate-400"/> </div>
              }
            </div>
        </div>
      )
      ...
      <div className='px-3.5 py-3.5'>
        {userData ? (
          ...
          <div className='flex-1 min-w-0'>
            <p className='text-[13.5px] font-semibold text-slate-100 truncate'>{userData?.
            name || "user"}</p>
          ...
          <div className='flex gap-1'>
              ...
              border-none bg-transparent text-yellow-600 cursor-pointer hover:bg-white/[0.
              08] hover:text-slate-400 transition-all duration-150'>
                <Coins size={16}/>
              </button>
              <button className='flex items-center justify-center w-7 h-7 rounded-[7px]
          ...
          <button className='w-full flex items-center justify-center gap-2 text-sm font-medium text-slate-200 bg-white/5 border border-white/10 rounded-xl py-2.5 cursor-pointer hover:bg-white/10 transition-colors duration-150'>
            Login
          </button>
        )}
        </div>
